...
public class EMR4MainTinnyCorpus {
...
//		AmazonSQS sqs = new AmazonSQSClient(credentials);
		...
		.withJar("s3://default-ds-ass2-elidor/ALLFinalMapReduce1.jar") // This should be a full map reduce application.
		.withArgs("s3n://dsp151/TinnyCorpus.txt", "s3n://default-ds-ass2-elidor/New4GBintermediate_1TinnyALLFinal5_2");
		...
		.withJar("s3://default-ds-ass2-elidor/FinalMapReduce2.jar") // This should be a full map reduce application.
		.withArgs("s3n://default-ds-ass2-elidor/New4GBintermediate_1TinnyALLFinal5_2","s3n://default-ds-ass2-elidor/New4GBintermediate_2TinnyALLFinal5_2" );
		...
		.withJar("s3://default-ds-ass2-elidor/FinalMapReduce3.jar") // This should be a full map reduce application.
		.withArgs("s3n://default-ds-ass2-elidor/New4GBintermediate_2TinnyALLFinal5_2", "s3n://default-ds-ass2-elidor/New4GBintermediate_3TinnyALLFinal5_2");
		...
		.withJar("s3://default-ds-ass2-elidor/FinalMapReduce4.jar") // This should be a full map reduce application.
		.withArgs("s3n://default-ds-ass2-elidor/New4GBintermediate_3TinnyALLFinal5_2", "s3n://default-ds-ass2-elidor/New4GBoutputTwiterTinnyALLFinal5_2", args[0]);
		...
		bootstrappingArgs1.add("mapred.tasktracker.map.tasks.maximum=20");
...
//		bootstrappingArgs2.add("--namenode-heap-size=51200");
...
//		bootstrappingArgs3.add("mapred.tasktracker.reduce.tasks.maximum=1");
		bootstrappingArgs3.add("mapred.tasktracker.reduce.tasks.maximum=20");
...
//        new+++
        bootstrapActions.add(new BootstrapActionConfig("increase the JVM heap size and task timeout",
                ...
                ArrayList<String> bootstrappingArgs5 = new ArrayList<String>();
        bootstrappingArgs5.add("-m");
        bootstrappingArgs5.add("mapred.task.timeout=1800000");
        bootstrapActions.add(new BootstrapActionConfig("The default timeout for a mapper or reducer script",
                new ScriptBootstrapActionConfig("s3://elasticmapreduce/bootstrap-actions/configure-hadoop", bootstrappingArgs5)));
